#!/usr/bin/env python3
"""
Direct ElevenLabs Text-to-Speech Service for DARIA Interview Tool
Uses direct HTTP requests instead of the elevenlabs library to avoid compatibility issues
"""
...
def health_check():
    ...
    return jsonify({
        "status": "ok", 
        "service": "ElevenLabs Direct TTS Service", 
    ...
    try:
        ...
        if ELEVENLABS_API_KEY:
            ...
            if response.status_code == 200:
                ...
                resp = Response(response.content, mimetype='audio/mpeg')
...
if __name__ == '__main__':
    ...
    print("Starting ElevenLabs TTS Service on port", args.port)
